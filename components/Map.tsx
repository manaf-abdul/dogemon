...
const Map = () => {
    ...
    return (
      ...
      >
          ...
          {/* https://api.mapbox.com/styles/v1/manafabdul/clqmoeng800py01qu4gm81twq/tiles/256/{z}/{x}/{y}@2x?access_token=sk.eyJ1IjoibWFuYWZhYmR1bCIsImEiOiJjbHFtb3h0bGQwOXV0Mmptd2E0MmczbXU2In0._KGhjTnoa0D8WnFSsQDGgg */}
          <TileLayer
              url={`https://api.mapbox.com/styles/v1/manafabdul/clqmq60f100qn01o3g734fc27/tiles/256/{z}/{x}/{y}@2x?access_token=sk.eyJ1IjoibWFuYWZhYmR1bCIsImEiOiJjbHFtb3h0bGQwOXV0Mmptd2E0MmczbXU2In0._KGhjTnoa0D8WnFSsQDGgg`}
